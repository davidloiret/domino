...
Document.prototype = Object.create(Node.prototype, {
  ...
  getElementsByName: { value: Element.prototype.getElementsByName, writable: isApiWritable },
  getElementsByTagName: { value: Element.prototype.getElementsByTagName, writable: isApiWritable },
  getElementsByTagNameNS: { value: Element.prototype.getElementsByTagNameNS, writable: isApiWritable },
  getElementsByClassName: { value: Element.prototype.getElementsByClassName, writable: isApiWritable },
...
*/
  if (node.nodeType === Node.ELEMENT_NODE) {
    ...
    for(var i = 0, n = kids.length; i < n; i++)
      recursivelyRoot(kids[i]);
    if (node.shadowRoot) {
      recursivelyRoot(node.shadowRoot);
    }
  }
}
